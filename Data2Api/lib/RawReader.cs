...
namespace Data2Api.lib
{
    public class RawReader
    {
        ...
        public void CentroidsFromArrays(Scan scan, double[] mzArray, double[] intensityArray, double[] baseline = null, double[] noise = null)
        {
        ...
        private void SetPrecursorScanNumber(Scan scan)
        {
